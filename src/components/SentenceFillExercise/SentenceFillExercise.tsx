...
import { createStyles } from './SentenceFillExercise.styles';

export interface SentenceFillExerciseProps {
...
export function SentenceFillExercise({
  exercise,
  activeGapIndex,
  userAnswers,
  status,
  pulseAnim,
}: SentenceFillExerciseProps): React.JSX.Element {
